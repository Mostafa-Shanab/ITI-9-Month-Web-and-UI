export class SoundEngine {
    constructor() {
        this.flip_sound = new Audio("./assets/audio/flip.mp3");
        this.match_sound = new Audio("./assets/audio/good.mp3");
        this.wrong_sound = new Audio("./assets/audio/fail.mp3");
        this.win_sound = new Audio("./assets/audio/game-over.mp3");
        this.bg_music = new Audio("./assets/audio/fulltrack.mp3");
