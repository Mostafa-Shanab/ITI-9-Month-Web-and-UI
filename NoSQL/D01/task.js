...
db.instructors.insert({firstName: "Mostafa", lastName: "Shanab"})
...
db.instructors.find()
db.instructors.insert({firstName: "Mostafa", lastName: "Shanab"})
db.instructors.insert({_id: 1, firstName: "Mostafa", lastName: "Shanab"})
//1
db.instructors.find()
//2
...
//4
db.instructors.find({'address.city':"mansoura"},{firstName:1, age:1, 'address.city': 1, _id:0})
